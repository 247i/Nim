...
SEARCH_DIR("/R/winlibs64_stage/inst_binutils-2.36.1/share/binutils/x86_64-w64-mingw32/lib"); SEARCH_DIR("/R/winlibs64_stage/inst_binutils-2.36.1/share/binutils/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
  ...
  .zdebug_sup BLOCK(__section_alignment__) (NOLOAD) :
  {
    *(.zdebug_sup)
  }
  /* For Go and Rust.  */
